...
description: "Develop theoretically grounded hypotheses and draft publication-ready Theory sections for social science research. Covers puzzle framing (5 types: anomaly, contradiction, extension, mechanism, scope), framework selection from 25+ sociological/linguistic theories (stratification, networks, culture, institutional, life course, analytical sociology Coleman's boat + Hedström DBO, intersectionality, racial formation, social movements, status characteristics, signaling, non-Western: guanxi/Ubuntu/coloniality/world-systems), mechanism chain specification using analytical sociology micro-macro logic, hypothesis formalization (7 types: directional, interaction, mediation, curvilinear, comparative, boundary condition, null-as-finding) with formal hypothesis table and competing predictions table, text-based DAG construction (routes to /scholar-causal for identification), and journal-calibrated theory section drafts (ASR/AJS 1000–1500 words; Demography 600–1000 words; NHB/Science Advances 300–600 words integrated in Introduction; NCS 200–400 words; qualitative propositional claims). Write tool saves internal theory log + publication-ready section draft. Use after /scholar-lit-review and before /scholar-design."
