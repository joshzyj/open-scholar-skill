...
OUTPUT_ROOT="${OUTPUT_ROOT:-output}"
BASE="${OUTPUT_ROOT}/scholar-compute-log-[topic-slug]-[YYYY-MM-DD]"
...
**Re-run this version check with the appropriate BASE for each output file.** For File 2 (results), use `BASE="${OUTPUT_ROOT}/scholar-compute-results-[topic-slug]-[YYYY-MM-DD]"`.
